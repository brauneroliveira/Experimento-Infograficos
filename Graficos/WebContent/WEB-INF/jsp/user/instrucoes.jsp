                ...
                <section class="panel">
					...
					<form class="form-horizontal bucket-form" method="get">
						...
						<h3>Olá ${userWeb.nome}!</h3>
							...
							Hoje você completará a <b>fase B</b> dessa atividade (interação com o material educacional e pós-teste). Nessa fase, você terá acesso a 15 textos, em sua maioria relacionados ao tema meio ambiente, mas não somente. 
							Você deve ler os textos e analisar os gráficos para extrair informações e dados sobre o tema abordado.							
                ...
                <section class="panel">
                    ...
                    <div style="text-align:center;" class="panel-body">
                   		<form action="<c:url value="/questhumor"/>">
	                        ...
	                        <button type="submit" class="btn btn-info btn-lg">Ver gráficos <i class="fa fa-arrow-right"></i></button>
                        </form>
                    </div>
                </section>
            </div>
