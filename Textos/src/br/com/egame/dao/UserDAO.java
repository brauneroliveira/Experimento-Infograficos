...
public class UserDAO {
	...
	public Questoes getQuestao(int grupo, int categoria) { /*retorna um objeto*/
		@SuppressWarnings("unchecked")
		Questoes questao = (Questoes) session.createCriteria(Questoes.class)
				.add(Restrictions.eq("grupo", grupo))
	...
	public void salvaQuestHumor(QuestHumor humor) { /*salva a resposta de humor*/
		this.session.save(humor); //o metodo save gera um novo identificador para o objeto passado antes de persistir
