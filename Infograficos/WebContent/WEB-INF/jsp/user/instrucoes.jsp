                ...
                <section class="panel">
					...
					<form class="form-horizontal bucket-form" method="get">
						...
						<h3>Olá ${userWeb.nome}!</h3>
							...
							<br>
							<b>Você está participando de uma atividade desenvolvida pelo <b>Laboratório de Computação Aplicada a Educação da USP</b>.
							&nbsp&nbsp<img alt="" src="images/disciplina/Logo_transparente.png" height="124" width="256">
							<br><br><big>
							
							Hoje você completará a fase B dessa atividade (interação com o material educacional e pós-teste). Nessa fase, você terá acesso a 15 infográficos, em sua maioria relacionados ao tema meio ambiente, mas não somente. 
							Você deve ler os infográficos e extrair informações e dados sobre o tema abordado.							
                ...
                <section class="panel">
                    ...
                    <div style="text-align:center;" class="panel-body">
                   		<form action="<c:url value="/questhumor"/>">
	                        ...
	                        <button type="submit" class="btn btn-info btn-lg">Ver infográficos <i class="fa fa-arrow-right"></i></button>
                        </form>
                    </div>
                </section>
            </div>
