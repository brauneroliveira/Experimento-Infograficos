                ...
                <section class="panel">
					...
					<form class="form-horizontal bucket-form" method="get">
						...
						<h4>OBRIGADO!</h4>
								...
								<br>Muito bem, você acabou de visualizar os 15 infográficos. 
								O teste a seguir é composto de 45 questões sobre os infográficos que você acabou de analisar e 
								tem como objetivo medir o quanto você conseguiu aprender sobre eles.
