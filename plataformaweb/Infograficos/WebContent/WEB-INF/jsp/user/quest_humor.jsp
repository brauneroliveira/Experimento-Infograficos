		...
		<div class="col-sm-12">
			<section class="panel"> 
				<header class="panel-heading">
					<h4>Como você está se sentindo em relação à esta atividade? </h4>
		         </header>
			...
			<div class="panel-body">
				...
				<form name="f1" class="form-horizontal bucket-form" " method="get" action="<c:url value="/questhumor"/>"> <!-- C:\Users\kamil\Google Drive\Infografico projeto\Infograficos\WebContent\images\questoes  -->
					<div class="form-group "style="text-align:center; color: black">
							<b>Desagradável</b>
							<img align="middle" src="images/infograficos/valencia.png"  width="900px" height="auto" style=" margin:20px" />
							<b>Agradável</b>
						<div class="form-group" >
							<label class=" control-label" for="inputSuccess"></label>
							<div class="form-group" style="color: black">
								
								 <input align="middle" type="range" id="respostaHumor" name="respostaHumor" min="1" max="9" step="1" style="width: 780px; height: auto" list="numbers"/>
								<datalist id="numbers">
								  <option>1</option> 
								  <option>2</option>
								  <option>3</option>
