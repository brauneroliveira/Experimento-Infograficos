var guidely = (function() {
	return {
		...
		_defaults : {
			showOnStart : true,
			welcome : true,
			welcomeTitle : 'Bem vindo ao E-Game tour!',
			welcomeText : 'Vamos passar por um rápido tour pelo E-Game para fazer a sua experiência mais fácil. Estamos à disposição para esclarecer todas as suas dúvidas, caso precise. E boa sorte!',
			overlay : true,
			startTrigger : true,
			escClose : true,
			keyNav : true,
		...
		_getAnchorCoords : function(options) {
			...
			numberOffset = 45 / 2;
			offsetMap = {
				top_left : [ coords.top - numberOffset,
						coords.left - numberOffset ],
				top_right : [ coords.top - numberOffset,
						(coords.left + coords.width) - numberOffset ],
				top_middle : [ coords.top - numberOffset,
						coords.left + (coords.width / 2) - numberOffset ],
				middle_left : [
						coords.top + (coords.height / 2) - numberOffset,
						coords.left - numberOffset ],
				middle_middle : [
						coords.top + (coords.height / 2) - numberOffset,
						coords.left + (coords.width / 2) - numberOffset ],
				middle_right : [
						coords.top + (coords.height / 2) - numberOffset,
						coords.left + coords.width - numberOffset ],
				bottom_right : [ coords.top + coords.height - numberOffset,
						(coords.left + coords.width) - numberOffset ],
				bottom_middle : [ coords.top + coords.height - numberOffset,
						coords.left + (coords.width / 2) - numberOffset ],
				bottom_left : [ coords.top + coords.height - numberOffset,
						coords.left - numberOffset ]
			};
