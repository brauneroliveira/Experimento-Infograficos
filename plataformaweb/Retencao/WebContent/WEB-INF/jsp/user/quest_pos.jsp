...
<title>Teste Retenção</title>

<!-- SCRIPTS PARA LOG -->
<script type="text/javascript">
	function antesDoSubmit(){
		var d = new Date();
		var ta = d.getTime(); /*A Number, representing the number of milliseconds since midnight January 1, 1970*/
		var diferenca = ta - document.getElementById("tempoChegada").value;
		document.getElementById("logTempoPermanenciaA").value = diferenca/1000; /*segundos*/
...
<section id="container" >
	...
	<div class="row">
		<div class="col-sm-12">
			...
			<div class="panel-body" style="teste-align:left">
				<div class="control-label" style="text-align: justify; margin-left:25px">
		     <p><br>Marque uma opção para indicar sua resposta.
		     <br><br><br>
		     </p>
		     </div>
				...
				<form name="f1" class="form-horizontal bucket-form" method="get" action="<c:url value="/gravaRespostasPos"/>"> <!-- C:\Users\kamil\Google Drive\Infografico projeto\Infograficos\WebContent\images\questoes  -->
					...
					<div class="form-group "style="text-align:center; color: black">
						<label style="text-align:left" class="control-label col-lg-12 ">${quest1.titulo} ${quest1.pergunta}</label> <!-- ${questoes.pergunta} -->
					</div>
					<div class="form-group" style="text-align:left">
						<label class="" for="inputSuccess"></label>
						<div class="col-lg-6" style="color: black; margin-left:20px">
							<div class="radio">
					...
					<div class="form-group "style="text-align:center; color: black">
						<label style="text-align:left" class="control-label col-lg-12 ">${quest2.titulo} ${quest2.pergunta}</label> <!-- ${questoes.pergunta} -->
					</div>
					...
					<div class="form-group "style="text-align:center; color: black">
						<label style="text-align:left"  class="control-label col-lg-12 ">${quest3.titulo} ${quest3.pergunta}</label> <!-- ${questoes.pergunta} -->
					</div>
					<div class="form-group" >
						<label class="" for="inputSuccess"></label>
						<div class="col-lg-6" style="color: black; margin-left:20px">
					...
					<div class="form-group "style="text-align:center; color: black">
						<label style="text-align:left"  class="control-label col-lg-12 ">${quest4.titulo} ${quest4.pergunta}</label> <!-- ${questoes.pergunta} -->
					</div>
					<div class="form-group" >
						<label class="" for="inputSuccess"></label>
						<div class="col-lg-6" style="color: black; margin-left:20px">
					...
					<div class="form-group "style="text-align:center; color: black">
						<label style="text-align:left"  class="control-label col-lg-12 ">${quest5.titulo} ${quest5.pergunta}</label> <!-- ${questoes.pergunta} -->
					</div>
					<div class="form-group" >
						<label class="" for="inputSuccess"></label>
						<div class="col-lg-6" style="color: black; margin-left:20px">
					...
					<div class="form-group "style="text-align:center; color: black">
						<label style="text-align:left"  class="control-label col-lg-12 ">${quest6.titulo} ${quest6.pergunta}</label> <!-- ${questoes.pergunta} -->
					</div>
					<div class="form-group" >
						<label class="" for="inputSuccess"></label>
						<div class="col-lg-6" style="color: black; margin-left:20px">
					...
					<div class="form-group "style="text-align:center; color: black">
						<label style="text-align:left"  class="control-label col-lg-12 ">${quest7.titulo} ${quest7.pergunta}</label> <!-- ${questoes.pergunta} -->
					</div>
					<div class="form-group" >
						<label class="" for="inputSuccess"></label>
						<div class="col-lg-6" style="color: black; margin-left:20px">
					...
					<div class="form-group "style="text-align:center; color: black">
						<label style="text-align:left"  class="control-label col-lg-12 ">${quest8.titulo}  ${quest8.pergunta}</label> <!-- ${questoes.pergunta} -->
					</div>
					<div class="form-group" >
						<label class="" for="inputSuccess"></label>
						<div class="col-lg-6" style="color: black; margin-left:20px">
					...
					<div class="form-group "style="text-align:center; color: black">
						<label style="text-align:left"  class="control-label col-lg-12 ">${quest9.titulo} ${quest9.pergunta}</label> <!-- ${questoes.pergunta} -->
					</div>
					<div class="form-group" >
						<label class="" for="inputSuccess"></label>
						<div class="col-lg-6" style="color: black; margin-left:20px">
					...
					<div class="form-group "style="text-align:center; color: black">
						<label style="text-align:left"  class="control-label col-lg-12 ">${quest10.titulo} ${quest10.pergunta}</label> <!-- ${questoes.pergunta} -->
					</div>
					<div class="form-group" >
						<label class="" for="inputSuccess"></label>
						<div class="col-lg-6" style="color: black; margin-left:20px">
					...
					<div class="form-group "style="text-align:center; color: black">
						<label style="text-align:left"  class="control-label col-lg-12 ">${quest11.titulo} ${quest11.pergunta}</label> <!-- ${questoes.pergunta} -->
					</div>
					<div class="form-group" >
						<label class="" for="inputSuccess"></label>
						<div class="col-lg-6" style="color: black; margin-left:20px">
					...
					<div class="form-group "style="text-align:center; color: black">
						<label style="text-align:left"  class="control-label col-lg-12 ">${quest12.titulo} ${quest12.pergunta}</label> <!-- ${questoes.pergunta} -->
					</div>
					<div class="form-group" >
						<label class="" for="inputSuccess"></label>
						<div class="col-lg-6" style="color: black; margin-left:20px">
					...
					<div class="form-group "style="text-align:center; color: black">
						<label style="text-align:left"  class="control-label col-lg-12 ">${quest13.titulo} ${quest13.pergunta}</label> <!-- ${questoes.pergunta} -->
					</div>
					<div class="form-group" >
						<label class="" for="inputSuccess"></label>
						<div class="col-lg-6" style="color: black; margin-left:20px">
					...
					<div class="form-group "style="text-align:center; color: black">
						<label style="text-align:left"  class="control-label col-lg-12 ">${quest14.titulo} ${quest14.pergunta}</label> <!-- ${questoes.pergunta} -->
					</div>
					<div class="form-group" >
						<label class="" for="inputSuccess"></label>
						<div class="col-lg-6" style="color: black; margin-left:20px">
					...
					<div class="form-group "style="text-align:center; color: black">
						<label style="text-align:left"  class="control-label col-lg-12 ">${quest15.titulo} ${quest15.pergunta}</label> <!-- ${questoes.pergunta} -->
					</div>
					<div class="form-group" >
						<label class="" for="inputSuccess"></label>
						<div class="col-lg-6" style="color: black; margin-left:20px">
						...
						<input type="hidden" name="logRetencao.id" id="logId" value="${logRetencao.id}">
						<input type="hidden" name="logRetencao.idUser" id="logIdUser" value="${logRetencao.idUser}">
						<input type="hidden" name="logRetencao.tempoPermanenciaA" id="logTempoPermanenciaA" value="${logRetencao.tempoPermanenciaA}">
						<input type="hidden" name="logRetencao.tempoPermanenciaB" id="logTempoPermanenciaB" value="${logRetencao.tempoPermanenciaB}">
						<input type="hidden" name="logRetencao.tempoPermanenciaC" id="logTempoPermanenciaC" value="${logRetencao.tempoPermanenciaC}">
